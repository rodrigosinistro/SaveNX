...
class BaseState
{
    public:
        ...
        /// @param isClosable Optional. Controls whether or not the state should allow SaveNX to close.
        ...
        /// @brief Deactivates state and allows SaveNX to purge it from the vector.
        void deactivate();
        ...
        /// @brief Returns whether or not SaveNX should allow closing while state is active.
