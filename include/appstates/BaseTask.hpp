...
class BaseTask : public BaseState
{
    ...
    protected:
        ...
        /// @brief Displays the "can't quit SaveNX" when plus is pressed.
        void pop_on_plus();

        /// @brief This function renders the loading glyph in the bottom left corner.
        /// @note This is mostly just so users don't think SaveNX has frozen when operations take a long time.
