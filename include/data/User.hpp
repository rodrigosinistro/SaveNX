...
namespace data
{
    ...
    class User final : public data::DataCommon
    {
        public:
            ...
            /// @param pathSafeNickname The path safe version of the save data since SaveNX is in everything the Switch supports.
            ...
            /// @brief Returns a stable folder key for this Switch account/save type.
            /// @note Account keys are based on the full 128-bit AccountUid, never on a mutable nickname.
