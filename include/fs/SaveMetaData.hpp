...
namespace fs
{
    ...
    /// @brief Ensures a backup belongs to the selected title, user and save slot before any destructive restore step.
    bool validate_save_meta_data(const FsSaveDataInfo *saveInfo, const SaveMetaData &meta) noexcept;
} // namespace fs
